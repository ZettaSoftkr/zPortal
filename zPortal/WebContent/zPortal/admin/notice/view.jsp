   ...
   <div class="Grid_Area">
               <table class="table_Type">
                       ...
                       <tbody>		
                           ...
                           <tr>
                               <td class="listView" colspan="3" id="fileView"></td>
                           </tr> 
                           <tr>
          ...
          <div class="btn_area">
            	<button type="button" class="button_Area" id="editForm_button">
                    <span class="whitishBtn button_small"><span class="fontawesome_Btn fa-list-alt"></span>수정</span>
                </button>
                <button type="button" class="button_Area" id="deleteForm_button">
