...
//         ),
  ...
  var visualizationNodeTemplateForPalette =
	  $(go.Node, "Vertical",
	     { locationObjectName: "SHAPE",
	       locationSpot: go.Spot.Center,
	       selectionAdorned: false
  ...
  myPaletteLevel4.model = $(go.GraphLinksModel,
		    {
		      ...
		      copiesArrayObjects: true,
		      nodeDataArray: [
		    { key: 1001, category: "visualization", text: "Table", chartType: "table" },
		    { key: 1002, category: "visualization", text: "Line", chartType: "line" },
		    { key: 1003, category: "visualization", text: "Bar", chartType: "bar" },
		    { key: 1004, category: "visualization", text: "Column", chartType: "column" },
		    { key: 1005, category: "visualization", text: "Bubble", chartType: "bubble" },
		    { key: 1006, category: "visualization", text: "Gauge", chartType: "gauge" },
		    { key: 1008, category: "visualization", text: "Pie", chartType: "pie" },
		    { key: 1009, category: "visualization", text: "ScatterPlot", chartType: "ScatterPlot" },
		    { key: 1010, category: "visualization", text: "GeoMap", chartType: "geoMap" },
		    { key: 1011, category: "visualization", text: "HeatMap", chartType: "heatMap" },
		    { key: 1012, category: "visualization", text: "RelationGraph", chartType: "relationGraph" },
		    { key: 1013, category: "visualization", text: "Gantt", chartType: "gantt" },
		    { key: 1014, category: "visualization", text: "Sankey", chartType: "sankey" },
		    { key: 1015, category: "visualization", text: "State", chartType: "state" },
		    { key: 1016, category: "visualization", text: "DistancePath", chartType: "DistancePath" },
		    { key: 1017, category: "visualization", text: "TimeLine", chartType: "timeLine" },
		    { key: 1018, category: "visualization", text: "TreeMap", chartType: "treeMap" },
		    { key: 1019, category: "visualization", text: "HierarchicalEdgeBundling", chartType: "hedgebundling" },
		    { key: 1020, category: "visualization", text: "CirclePacking", chartType: "circlePacking" },
		      ]  // end nodeDataArray
		    });  // end model
...
//	myDiagram.isModified = false;
	...
	jQuery.getJSON(file, function(jsondata) {
		// create the model from the data in the JavaScript object parsed from
		// JSON text
		// myDiagram.model = new go.GraphLinksModel(jsondata["nodes"],
		// jsondata["links"]);
