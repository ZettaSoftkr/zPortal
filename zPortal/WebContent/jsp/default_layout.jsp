...
<!-- 			   <button type="button" class="close" id="closeMsgBox">&times;</button> -->
   ...
   ================================================== -->
	...
	<script language="javascript" src="${pageContext.request.contextPath}/dtree/dtree.js"></script>
	...
	<script language="javascript" src="${pageContext.request.contextPath}/assets/js/jquery.fileupload.js"></script>
