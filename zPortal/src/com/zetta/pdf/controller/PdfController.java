package com.zetta.pdf.controller;
...
public class PdfController {
	...
	@RequestMapping(value = "/admin/pdf/gotoPage.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/pdf/gotoPage.do", method = RequestMethod.GET)
