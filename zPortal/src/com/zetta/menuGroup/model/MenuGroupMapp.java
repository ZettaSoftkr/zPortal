...
@Entity
@Table(name="PTL_TB_MENUGROUP_MAPNG_R")
public class MenuGroupMapp
{
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int bi_menu_group_sn;
	@Column private String bi_menu_group_id;
	@Column	private String bi_portal_menu_id; 
	...
	public int getBi_menu_group_sn() {
		return bi_menu_group_sn;
	}

	public void setBi_menu_group_sn(int bi_menu_group_sn) {
		this.bi_menu_group_sn = bi_menu_group_sn;
	}
